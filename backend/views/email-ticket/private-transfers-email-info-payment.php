<html><head>
        ...
        <title>Private Transfers Information Gilitransfers</title>
</head>
...
Private Transfers Information Gilitransfers
<span style="display:inline;">
<br>
...
<center><span style="font-size:15 ; font-weight:bold;text-decoration:none;">Private Transfers Information</span>
</center>
<table contenteditable="false">
<tbody>
<tr>
<td valign="bottom" align="justify">Dear <?= $modelPrivateBooking[0]->idPayment->name ?>. <p>Thank you for choosing Gilitransfers.com to reserve your transfers. we have found and confirmed the best operators to serve your trip. Here we include operator contact Below:</p><span style="display:inline;">
  </span></td>
...
<?php foreach($modelPrivateBooking as $x => $valPrivateBooking): ?>
  <!-- Trip Info Start -->
...
<tbody>
  <tr>
    <td>
      <?= $valPrivateBooking->idTrip->idRoute->fromRoute->location." -> ".$valPrivateBooking->idTrip->idRoute->toRoute->location." ( ".date('d-m-Y H:i',strtotime($valPrivateBooking->date_trip)).")" ?> 
    </td>
  </tr>
</tbody>
</table>
<?php if($valPrivateBooking->note != null || $valPrivateBooking->note != " "): ?>
<table style="color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px; margin-bottom:20px;" width="100%" contenteditable="false" cellspacing="0" cellpadding="0" border="0">
<caption style="text-align: left; font-size: 15px; font-weight: bold;">Additional Information</caption>
<tbody>
  <tr>
    <td>
      <?= $valPrivateBooking->note ?> 
    </td>
  </tr>
</tbody>
</table>
...
<!-- Operator Info Start -->
<table style="color:#333 !important;font-family: arial,helvetica,sans-serif;font-size:12px; margin-bottom:20px;" width="100%" contenteditable="false" cellspacing="0" cellpadding="0" border="0">
<caption style="text-align: left; font-size: 15px; font-weight: bold;">Operator/Driver Contact</caption>
<tbody>
<tr>
  <td>Name</td>
  <td>: <?= $valPrivateBooking->idOperator->name ?></td>
</tr>
<tr>
  <td>Phone</td>
  <td>: <?= $valPrivateBooking->idOperator->phone ?></td>
</tr>
<tr>
  <td>Email</td>
  <td>: <?= $valPrivateBooking->idOperator->email ?></td>
</tr>
<tr>
  <td style="padding-bottom: 25px; border-bottom: 2px #333 solid;"></td>
  <td style="padding-bottom: 25px; border-bottom: 2px #333 solid;"></td>
</tr>
</tbody>
</table>
