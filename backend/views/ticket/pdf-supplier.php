...
require_once Yii::getAlias('@console')."/phpqrcode/qrlib.php"; //<-- LOKASI FILE UTAMA PLUGINNYA
...
<?php 
$isi_teks = "http://gilitraansfers.com/".$modelBooking->id;
...
?>
  ...
  <tr>
    <td class="secondary-text" style="border-bottom: 2px solid #BDBDBD; padding-bottom: 15px;">
      <?= count($modelBooking->affectedPassengers) ?> Pax
    </td>
    <td class="secondary-text" style="border-bottom: 2px solid #BDBDBD; padding-bottom: 15px;">
...
<table class="table table-striped ">
  ...
  <tbody>
  <tr>
    <td><?= $modelBooking->idPayment->name?></td>
    <td><?= $modelBooking->idPayment->phone ?></td>
    <td><?= $modelBooking->idPayment->email ?></td>
