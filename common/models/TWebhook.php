...
class TWebhook extends \yii\db\ActiveRecord
{
    ...
    public static function requestPaymentDetail($token,$parent_payment){
        try {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL            => "".Yii::$app->params['PaypalWebHookUrl'].$parent_payment."",
            ...
            "postman-token: 209203db-d4c0-6516-6e77-5a066d0b34c1"
                ...
                return $this->requestPaymentDetail($token,$parent_payment);
            }
    }
    ...
    public static function requestToken(){
        try {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL            => "".Yii::$app->params['PaypalTokenUrl']."",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING       => "",
                CURLOPT_MAXREDIRS      => 10,
                CURLOPT_TIMEOUT        => 30,
                ...
                CURLOPT_HTTPHEADER     => array(
                "authorization: Basic ".Yii::$app->params['PaypalClientScreetKey']."",
                "cache-control: no-cache",
